...
import { InstagramVideoMessage } from './InstagramVideoMessage';
...
const MessageContent = ({
  ...
  const isVideoMessage = item.msgtype === MsgType.Video;
  const instagramUrl =
    isImageMessage || isVideoMessage ? getInstagramUrl(item.content) : null;
  ...
  // Instagram video: show clickable URL
  if (isVideoMessage && instagramUrl) {
    return (
